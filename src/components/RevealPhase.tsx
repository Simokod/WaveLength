...
export const RevealPhase = ({ currentPlayer, allPlayers, round, gameMode, onNextPlayer }: RevealPhaseProps) => {
      ...
      >
        <Fade in timeout={800}>
          <Box>
            ...
            {/* Dial */}
            <Box sx={{ mb: { xs: 0.3, sm: 0.5 }, display: "flex", justifyContent: "center" }}>
              <Dial
            ...
            {/* Result Statistics */}
            <StyledPaper elevation={0} sx={{ mb: { xs: 1.5, sm: 2 }, py: { xs: 0.8, sm: 1.5 } }}>
              <Box 
                sx={{ 
                  display: "grid",
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {Math.round(Math.abs(round.targetPosition - round.guessPosition))}
                  </Typography>
                </Box>
              </Box>
            </StyledPaper>
            ...
            {gameMode === 'competitive' && (
              <StyledPaper elevation={0} sx={{ mb: { xs: 1.5, sm: 2 }, py: { xs: 0.8, sm: 1 } }}>
                <Box 
                  sx={{ 
                    display: "grid",
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          ...
                          border: isCurrentPlayer ? `2px solid ${player.color}` : "1px solid rgba(255,255,255,0.1)",
                          borderRadius: "6px",
                      ...
                      >
                        ...
                        <Typography
                          ...
                          sx={{
                            ...
                            top: -8,
                            left: 8,
                            background: index === 0 ? "#ffd700" : index === 1 ? "#c0c0c0" : index === 2 ? "#cd7f32" : "#6b7280",
            ...
            {/* Party Mode Message */}
            {gameMode === 'party' && (
              <StyledPaper elevation={0} sx={{ mb: { xs: 1.5, sm: 2 }, textAlign: "center", py: { xs: 0.8, sm: 1 } }}>
                <Typography
                  variant="body2"
                  sx={{
                    color: "rgba(255,255,255,0.8)",
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: { xs: "0 8px 25px 0 rgba(147, 51, 234, 0.4)", sm: "0 12px 35px 0 rgba(147, 51, 234, 0.6)" },
                  },
